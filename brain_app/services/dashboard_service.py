...
from brain_app.models.models import Fazenda, Cultura
...
class DashboardService:
    ...
    def get_dashboard_data(self) -> DashboardResponse:
        ...
        fazendas_por_estado = (
            self.db.query(Fazenda.estado, func.count(Fazenda.id))
        ...
        return DashboardResponse(
            ...
            culturas_plantadas=[{"nome_cultura": n, "area_plantada": float(a or 0)} for n, a in culturas_plantadas],
            uso_solo=[
