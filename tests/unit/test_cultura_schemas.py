...
def test_cultura_create_valid():
    data = {"nome_cultura": "Soja", "ano_safra": 2023, "area_plantada": Decimal("100.50"), "fazenda_id": 1}
...
def test_cultura_create_invalid_ano_safra():
    data = {"nome_cultura": "Milho", "ano_safra": 1800, "area_plantada": Decimal("100.50"), "fazenda_id": 1}
    with pytest.raises(ValidationError):
        CulturaCreateSchema(**data)
